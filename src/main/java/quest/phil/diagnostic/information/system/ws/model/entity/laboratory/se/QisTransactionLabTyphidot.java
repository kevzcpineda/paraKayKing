...
@Entity
@DynamicUpdate
@Table(name = "qis_transaction_laboratory_se_typhidot")
public class QisTransactionLabTyphidot implements Serializable {

	private static final long serialVersionUID = 4808463611436653668L;

	@JsonIgnore
	@Id
	private Long id;

	@Column(name = "igm", nullable = true, columnDefinition = "boolean default null")
	private Boolean igm;

	@Column(name = "igg", nullable = true, columnDefinition = "boolean default null")
	private Boolean igg;
	...
	public QisTransactionLabTyphidot() {
		super();
	}
