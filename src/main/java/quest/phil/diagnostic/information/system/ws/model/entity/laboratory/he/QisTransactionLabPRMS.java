...
@Entity
@DynamicUpdate
@Table(name = "qis_transaction_laboratory_he_prms")
public class QisTransactionLabPRMS implements Serializable {

	private static final long serialVersionUID = -2974245178641820187L;

	@JsonIgnore
	@Id
	private Long id;

	@Column(name = "pr131", nullable = true)
	private Float pr131;

	@Column(name = "malarial_smear", nullable = true, columnDefinition = "boolean default null")
	...
	public Float getPr131() {
		return pr131;
	}

	public void setPr131(Float pr131) {
		this.pr131 = pr131;
	}
