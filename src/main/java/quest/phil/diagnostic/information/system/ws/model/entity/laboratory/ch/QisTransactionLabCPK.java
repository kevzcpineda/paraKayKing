...
@Entity
@DynamicUpdate
@Table(name = "qis_transaction_laboratory_ch_cpk")
public class QisTransactionLabCPK implements Serializable {

	private static final long serialVersionUID = -8374486299324684184L;

	@JsonIgnore
	@Id
	private Long id;

	@Column(name = "cpk_mb", nullable = true)
	private Float cpkMB;

	@Column(name = "cpk_mm", nullable = true)
	private Float cpkMM;

	@Column(name = "total_cpk", nullable = true)
	private Float totalCpk;
	...
	public Float getCpkMB() {
		return cpkMB;
	}

	public void setCpkMB(Float cpkMB) {
		this.cpkMB = cpkMB;
	}

	public Float getCpkMM() {
		return cpkMM;
	}

	public void setCpkMM(Float cpkMM) {
		this.cpkMM = cpkMM;
	}

	public Float getTotalCpk() {
		return totalCpk;
	}

	public void setTotalCpk(Float totalCpk) {
