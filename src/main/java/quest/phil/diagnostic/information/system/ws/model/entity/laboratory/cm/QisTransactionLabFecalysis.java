...
@Entity
@DynamicUpdate
@Table(name = "qis_transaction_laboratory_cm_fecalysis")
public class QisTransactionLabFecalysis implements Serializable {

	private static final long serialVersionUID = 2240204329101964631L;
	...
	@Column(name = "consistency", nullable = true, length = 4)
	private String consistency;

	@Size(max = 120, message = "Microscopic Findings should not exceed {max} characters.")
	@Column(name = "microscopic_findings", nullable = true, length = 120)
	...
	public QisTransactionLabFecalysis() {
		super();
	}
