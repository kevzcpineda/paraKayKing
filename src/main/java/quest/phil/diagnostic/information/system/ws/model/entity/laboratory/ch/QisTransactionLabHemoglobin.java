...
@Entity
@DynamicUpdate
@Table(name = "qis_transaction_laboratory_ch_hemoglobin")
public class QisTransactionLabHemoglobin implements Serializable {

	private static final long serialVersionUID = -6843626809966471985L;

	@JsonIgnore
	@Id
	private Long id;
	
	@Column(name = "hemoglobin_a1c", nullable = true)
	private Float hemoglobinA1C;
	...
	public QisTransactionLabHemoglobin() {
		super();
	}
	...
	public Float getHemoglobinA1C() {
		return hemoglobinA1C;
	}

	public void setHemoglobinA1C(Float hemoglobinA1C) {
