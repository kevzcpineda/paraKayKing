...
@Entity
@DynamicUpdate
@Table(name = "qis_transaction_laboratory_ch_rbs")
public class QisTransactionLabRBS implements Serializable {

	private static final long serialVersionUID = 4606078056535088074L;

	@JsonIgnore
	@Id
	private Long id;

	@Column(name = "rbs", nullable = true)
	private Float rbs;
