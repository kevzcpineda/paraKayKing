package quest.phil.diagnostic.information.system.ws.security;
...
public class JwtTokenUtil implements Serializable {
	...
	private static final long serialVersionUID = -481691405270442998L;

	public static final long JWT_TOKEN_VALIDITY = 10 * 60 * 60; // 10hrs
	...
	public String generateToken(QisUserDetails userDetails) {
	...
	public Boolean validateLogoutUser(String token, QisUser qisUser) {

		boolean flag = false;
		QisLogout qisLogout = qisLogoutRepository.findLogoutUserToken(qisUser.getId(), token);
		if(qisLogout != null) {
			flag = true;
		}
