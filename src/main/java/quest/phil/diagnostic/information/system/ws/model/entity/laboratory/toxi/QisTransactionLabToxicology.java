package quest.phil.diagnostic.information.system.ws.model.entity.laboratory.toxi;
...
@Entity
@DynamicUpdate
@Table(name = "qis_transaction_laboratory_toxicology")
public class QisTransactionLabToxicology implements Serializable {

	private static final long serialVersionUID = -6475459352399074492L;

	@JsonIgnore
	@Id
	private Long id;

	@Column(name = "methamphethamine", nullable = true, columnDefinition = "boolean default false")
	private Boolean methamphethamine;

	@Column(name = "tetrahydrocanabinol", nullable = true, columnDefinition = "boolean default false")
	...
	public QisTransactionLabToxicology() {
		super();
	}
