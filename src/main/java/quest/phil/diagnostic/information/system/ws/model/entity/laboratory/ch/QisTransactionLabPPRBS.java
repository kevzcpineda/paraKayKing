...
@Entity
@DynamicUpdate
@Table(name = "qis_transaction_laboratory_ch_pprbs")
public class QisTransactionLabPPRBS implements Serializable {

	private static final long serialVersionUID = 8148284456242171931L;

	@JsonIgnore
	@Id
	private Long id;

	@Column(name = "pprbs", nullable = true)
	private Float pprbs;
	...
	public Float getPprbs() {
		return pprbs;
	}

	public void setPprbs(Float pprbs) {
		this.pprbs = pprbs;
	}
