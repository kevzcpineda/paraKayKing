...
@Entity
@DynamicUpdate
@Table(name = "qis_transaction_laboratory_se_dengue")
public class QisTransactionLabDengue implements Serializable  {

	private static final long serialVersionUID = 1134499957358479340L;

	@JsonIgnore
	@Id
	private Long id;
	
	@Column(name = "result", nullable = true, columnDefinition = "boolean default null")
	...
	public QisTransactionLabDengue() {
		super();
	}
