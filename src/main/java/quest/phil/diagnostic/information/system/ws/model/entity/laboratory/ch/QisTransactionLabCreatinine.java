...
@Entity
@DynamicUpdate
@Table(name = "qis_transaction_laboratory_ch_creatinine")
public class QisTransactionLabCreatinine implements Serializable {

	private static final long serialVersionUID = -8161194753900359442L;
	...
	public QisTransactionLabCreatinine() {
		super();
	}
